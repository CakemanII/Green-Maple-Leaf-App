    ...
    initializeTabMenu() {
        ...
        new TabMenu({
            ...
            "load": async () => {
                ...
                let finished = false;
                let decision = false;
                MapEditorUIFileListDialog.show(await GeoeditFileManager.Instance.fetchAvailableGeoeditFiles(), async (uuid) => {
...
export class MapEditorUIColorPicker {
    constructor(initialColor, onConfirm, clickEvent, onChange, onCancel) {
        this.currentHue = 0;
    ...
    setupColorSwatchListeners() {
        ...
        this.regionInfoFillColorSwatch.addEventListener('click', (e) => {
            ...
            if (activeRegion) {
                ...
                new MapEditorUIColorPicker(originalColor, (selectedColor) => {
                    // On confirm
...
//# sourceMappingURL=editior_ui.js.map