export class TabMenu {
    constructor(menuSelectionFunctions) {
        ...
        this.tabMenuElement = document.getElementById('tab-menu');
    ...
    setupIFrameToggleListener() {
        window.addEventListener('message', (event) => {
            ...
            if (this.isMenuActive()) {
                ...
                const tabButtonPositionX = data.tabButtonPositionX;
     ...
     * Setup menu item selection listeners.
     */
    setupMenuItemSelectionListeners() {
        ...
        const menuOptionsContainer = document.getElementById(TabMenu.menuOptionButtonsContainerID);
...
TabMenu.menuOptionButtonsContainerID = 'tab-menu-options-container';
